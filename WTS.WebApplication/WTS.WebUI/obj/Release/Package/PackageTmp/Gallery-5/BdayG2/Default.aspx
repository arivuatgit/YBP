<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WTS.WebUI.Gallery_5.BdayG2.Default" %>
...
<body class="page">
    ...
    <div id="divBody" class="body-wrapper" >
        ...
        <div id="divG5ImageGalleryBdayG2" style="width: 200px; height: 100px; background-color: rgb(234, 234, 234); padding: 10px; margin: 5%;border-radius: 10px;">

            <div class="row">
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_058.jpg") %>" data-toggle="modal" data-target="#myModal" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_061.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_062.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_076.jpg") %>" />
                   
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_080.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_083.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_110.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_119.jpg") %>" />
                  
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_126.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_275.jpg" ) %>"/>
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_276.jpg" ) %>"/>
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_457.jpg") %>" />
                   
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_459.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_466.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_470.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_474.jpg") %>" />
    ...
    <div id="G5Modal" style="display:none;margin:0 auto;overflow:auto;">
                    ...
                    <div id="divBdayG2Slider" title="You can drag and resize window" class="carousel slide" data-ride="carousel" style="">
                       
                        <div class="carousel-inner">
                            <div id="divImgActive" class="item">
                                <a href="#">
                                    <img id="imgActive" class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_058.jpg") %>" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_061.jpg") %>" /></a>
                               
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_062.jpg") %>" alt="" /></a>
                               
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_076.jpg") %>" alt="" /></a>
                              
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_080.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_083.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_110.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_119.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_126.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_275.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_276.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_457.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_459.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_466.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_470.jpg") %>" alt="" /></a>
                             
                            </div>
                              <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Aegon/B_day_474.jpg") %>" alt="" /></a>
                             
                            </div>
                        </div>

                 
                        <a class="left carousel-control" href="#divBdayG2Slider" data-slide="prev">
                            <span class="glyphicon glyphicon-chevron-left"></span>
                        </a>
                        <a class="right carousel-control" href="#divBdayG2Slider" data-slide="next">
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            var div = $('#divG5ImageGalleryBdayG2');
