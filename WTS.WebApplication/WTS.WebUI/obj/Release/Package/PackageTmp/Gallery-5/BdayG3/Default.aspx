<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WTS.WebUI.Gallery_5.BdayG3.Default" %>
...
<body class="page">
    ...
    <div id="divBody" class="body-wrapper" >
        ...
        <div id="divG5ImageGalleryBdayG3" style="width: 200px; height: 100px; background-color: rgb(234, 234, 234); padding: 10px; margin: 5%; border-radius: 10px;">

            <div class="row">
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_015.jpg") %>" data-toggle="modal" data-target="#myModal" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_036.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_853_1.jpg") %>" />
                  
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_120.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_128.jpg") %>" />
                 
                  
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_565.jpg") %>" />
   
                      <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_065.jpg") %>" />
                   
               
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_786.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_853.jpg") %>" />
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_781.jpg" ) %>"/>
    ...
    <div id="G5Modal" style="display:none;margin:0 auto;overflow:auto;">
                    ...
                    <div id="divBdayG3Slider" title="You can drag and resize window" class="carousel slide" data-ride="carousel" style="">
                       
                        <div class="carousel-inner">
                            <div id="divImgActive" class="item">
                                <a href="#">
                                    <img id="imgActive" class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_015.jpg") %>" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_036.jpg") %>" /></a>
                               
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_065.jpg") %>" alt="" /></a>
                               
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_120.jpg") %>" alt="" /></a>
                              
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_128.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_565.jpg") %>" alt="" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_853_1.jpg") %>" alt="" /></a>
                             
                            </div>
                               <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_781.jpg") %>" alt="" /></a>
                             
                            </div>
                               <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_786.jpg") %>" alt="" /></a>
                             
                            </div>
                               <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Bday/Arya/B_day_853.jpg") %>" alt="" /></a>
                        ...
                        <a class="left carousel-control" href="#divBdayG3Slider" data-slide="prev">
                            <span class="glyphicon glyphicon-chevron-left"></span>
                        </a>
                        <a class="right carousel-control" href="#divBdayG3Slider" data-slide="next">
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            var div = $('#divG5ImageGalleryBdayG3');
