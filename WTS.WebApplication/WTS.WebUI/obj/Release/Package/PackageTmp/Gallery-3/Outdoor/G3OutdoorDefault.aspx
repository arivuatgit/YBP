<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G3OutdoorDefault.aspx.cs" Inherits="WTS.WebUI.Gallery_3.Outdoor.G3OutdoorDefault" %>
...
<body class="page">
    ...
    <div id="divBody" class="body-wrapper" >
        ...
        <div id="divG3ImageGalleryOutdoor" style="width: 200px; height: 100px; background-color: rgb(234, 234, 234); padding: 10px; margin: 5%; border-radius: 10px;">

            <div class="row">
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/_MG_1910.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/_MG_8558.jpg") %>" />
                   
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_3347.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_6070.jpg") %>" />
                  
                </div>
             <div class="column">
                  
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/collage-2.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_2775.jpg") %>" />
                </div>
                <div class="column">
                    
                     <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_6538.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_9329.jpg") %>" />
                    ...
                    <div id="divGallery4Slider" title="You can drag and resize window" class="carousel slide" data-ride="carousel" style="">
                        ...
                        <div class="carousel-inner">
                            <div id="divImgActive" class="item">
                                <a href="#">
                                    <img id="imgActive" class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/_MG_1910.jpg") %>" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img  class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/_MG_8558.jpg") %>" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img  class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/collage-2.jpg") %>" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img  class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_2775.jpg") %>" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img  class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_3347.jpg") %>" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img  class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_6070.jpg") %>" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img  class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_6538.jpg") %>" /></a>
                             
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Outdoor/IMG_9329.jpg") %>" /></a>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            var div = $('#divG3ImageGalleryOutdoor');
