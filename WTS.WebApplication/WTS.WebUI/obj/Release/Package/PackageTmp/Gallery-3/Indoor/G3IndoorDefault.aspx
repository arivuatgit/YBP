<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G3IndoorDefault.aspx.cs" Inherits="WTS.WebUI.Gallery_3.Indoor.G3IndoorDefault" %>
...
<body class="page">
    ...
    <div id="divBody" class="body-wrapper" >
        ...
        <div id="divG3ImageGalleryIndoor" style="width: 200px; height: 100px; background-color: rgb(234, 234, 234); padding: 10px; margin: 5%;border-radius: 10px;">

            <div class="row">
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1682.jpg") %>" data-toggle="modal" data-target="#myModal" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1713.jpg")%>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1787.jpg")%>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1856.jpg")%>" />
                   
                   
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_4072.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_7042.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/0S2A1777.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/0S2A1871.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/collage-1.jpg") %>" />
                   
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_1315.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2141.jpg") %>"/>
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2175.jpg") %>"/>
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2927.jpg")%>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2995.jpg")%>" />
                   
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_3139.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_9463.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_9976.jpg") %>" />
                     <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_3983.jpg")%>" />
    ...
    <div id="G3Modal" style="display:none;margin:0 auto;overflow:auto;">
                          

                    <div id="divGallery3Slider" title="You can drag and resize window" class="carousel slide" data-ride="carousel" style="">
                       
                        <div class="carousel-inner">
                            <div id="divImgActive" class="item">
                                <a href="#">
                                    <img id="imgActive" class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1682.jpg") %>" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1713.jpg")%>" /></a>
                               
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1787.jpg")%>" alt="" /></a>
                               
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_1856.jpg")%>" alt="" /></a>
                              
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_4072.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_7042.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/0S2A1777.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/0S2A1871.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/collage-1.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_1315.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2141.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2175.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2927.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_2995.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_3139.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_9463.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/IMG_9976.jpg") %>" alt="" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Baby/Indoor/_MG_3983.jpg") %>" alt="" /></a>
                             
                            </div>
                        </div>

                 
                        <a class="left carousel-control" href="#divGallery3Slider" data-slide="prev">
                            <span class="glyphicon glyphicon-chevron-left"></span>
                        </a>
                        <a class="right carousel-control" href="#divGallery3Slider" data-slide="next">
    ...
    <script src="<%=Page.ResolveClientUrl("~/assets/PageJs/gallery3.js")%>"></script>
    ...
    <script>
        ...
        $(document).on('ready', function () {
            ...
            var div = $('#divG3ImageGalleryIndoor');
