...
<body class="page">
    ...
    <div id="divBody" class="body-wrapper" >
        ...
        <div id="divG4ImageGallery" style="width: 200px; height: 100px; background-color: rgb(234, 234, 234); padding: 10px; margin: 5%; border-radius: 10px;">

            <div class="row">
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_0001.jpg") %>"  />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_0028.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_2975.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3436.jpg") %>" />
                  
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3460.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3975.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3999.jpg") %>" />
                    
                   
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3999_3.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_6273.jpg" ) %>"/>
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9124.jpg" ) %>"/>
                                    
                </div>
                <div class="column">
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9838.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9908.jpg") %>" />
                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9955.jpg") %>" />
    ...
    <div id="G4Modal" style="display:none;margin:0 auto;overflow:auto;">
        
                  

                    <div id="divGallery4Slider" title="You can drag and resize window" class="carousel slide" data-ride="carousel" style="">
                       
                        <div class="carousel-inner">
                            <div id="divImgActive" class="item">
                                <a href="#">
                                    <img id="imgActive" class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/Family/HomePage/IMG_0001.jpg") %>" /></a>
                             
                            </div>
                            <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_0028.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_2975.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3436.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3460.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3975.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3999.jpg") %>" /></a>
                               
                            </div>
                             
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_3999_3.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_6273.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9124.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9838.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9908.jpg") %>" /></a>
                               
                            </div>
                             <div class="item">
                                <a href="#">
                                    <img class="thumbnail" src="<%=Page.ResolveClientUrl("~/assets/images/Family/IMG_9955.jpg") %>" /></a>
                               
                            </div>
                        </div>

                 
                        <a class="left carousel-control" href="#divGallery4Slider" data-slide="prev">
                            <span class="glyphicon glyphicon-chevron-left"></span>
                        </a>
                        <a class="right carousel-control" href="#divGallery4Slider" data-slide="next">
    ...
    <script src="<%=Page.ResolveClientUrl("~/assets/PageJs/gallery4.js")%>"></script>
